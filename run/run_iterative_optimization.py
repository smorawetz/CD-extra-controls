...
while abs(fid - last_fid) > 1e-4 and i < 10:
...
final_state = wf_data[-1, :]
print("fidelity of final iterated state is ", calc_fid(targ_state, final_state))

fig, ax = plt.subplots()
ax.plot(fids, "o")
ax.xaxis.set_major_locator(MaxNLocator(integer=True))
plt.savefig(f"fids_vs_iter_start_infT_{AGPtype}_ord{agp_order}.png")
