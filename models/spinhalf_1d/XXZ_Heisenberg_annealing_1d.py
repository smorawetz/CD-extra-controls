...
class XXZ_Heisenberg_Annealing_1D(SpinHalf_1D):
    ...
    def __init__(
        ...
        self.pm_terms = [[-J / 6, *pairs[i]] for i in range(len(pairs))]
        self.flipped_pm_terms = [[J / 6, *pairs[i]] for i in range(len(pairs))]
        self.off_zz_terms = [[-J / 3, *pairs[i]] for i in range(len(pairs))]
        self.flipped_off_zz_terms = [[J / 3, *pairs[i]] for i in range(len(pairs))]
