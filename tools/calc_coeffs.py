...
def calc_alphas_grid(ham, grid_size, sched, agp_order, norm_type, gs_func=None):
...
def calc_lanc_coeffs_grid(ham, grid_size, sched, agp_order, norm_type, gs_func=None):
...
def calc_gammas_grid(ham, grid_size, sched, agp_order, norm_type, gs_func=None):
